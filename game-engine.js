...
var ENDINGS = [
  ...
  // ── 失败结局：过气顶流（流量≤0 即死触发）──────────────────────
  // 注意：流量归零排在身价归零之前，避免两者同时触发时被身价截胡
  {id:'forgotten',
  ...
  // ── 成功结局：疯狂星期四的M女王 ──────────────────────────────
  // 条件：商业版图≥900 且 自我≤220 且 操盘权<250 → 商业做大但自我缺失
  // 排在QNC前面，且加caopan<250避免纯权力路线被截胡
  // 2026-04-08: ziwo阈值从200→220，修复攻略路线因韩国支线额外自我导致差5点打不出的bug
  {id:'fastfood',
   condition:function(s){return s.shangyebantu>=900&&s.ziwo<=220&&s.caopan<250;},
